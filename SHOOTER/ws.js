...
// word database
const wordList = ['return', 'scanf', 'printf', 'break', 'run', 'esleif', 'dennis ritchie', 'importjava', 'packages', 'constants', 'variables', 'boolean', 'datatypes', 'python', 'keywords', 'expression', 'loops', 'compiler', 'errors', 'static', 'void', 'main', 'string', 'public', 'integer', 'tags', 'functions', 'script', 'applets', 'algorithm', 'default', 'export', 'class', 'create'];
const words = [];
let score = 0;
